...
do
    ...
    gcc -c -O3 -std=c18 -Wall -Wno-unused-variable $(sdl2-config --cflags) -Iinclude $c_file -o ./build/$c_file.o
done

OBJECTS=`find ./build -name "*.c.o"`
echo gcc $OBJECTS -lSDL2 -lSDL2_ttf -o ./pixelore
gcc $OBJECTS $(sdl2-config --libs) -lSDL2_ttf -lSDL2_image -o ./pixelore
